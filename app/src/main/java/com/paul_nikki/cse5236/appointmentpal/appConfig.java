...
public class AppConfig {
    ...
    public static String URL_NEW_APPOINTMENT = "https://murmuring-bastion-9980.herokuapp.com/newappointment";
    ...
    public static String URL_POSTSMSCODE = "https://murmuring-bastion-9980.herokuapp.com/postsmscode";
}